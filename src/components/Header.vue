...
const FacebookLink = 'https://www.facebook.com/profile.php?id=100011020122405';
const LinkedinLink = 'www.linkedin.com/in/praise-emmanuel-nacua-b30b84277';
const GithubLink = 'https://github.com/Just-Pyro';
...
<template>
    <header class="bg-lime-900 border-b border-gray-200">
        <nav class="mx-auto max-w-screen-xl px-12 py-4">
            <div class="flex flex-row items-center justify-between">
                <router-link to="/" class="flex flex-col">
                    <h1 class="font-bold text-white text-xl">Praise Emmanuel Nacua</h1>
                    <p class="font-light text-white text-lg text-gray-600">BSIT Student</p>
                </router-link>
                ...
                <div class="hidden lg:block">
                    <ul class="flex flex-row gap-8">
                        <li
                            :class="$route.name === 'home' ? 'text-white font-medium text-lg' : 'text-slate-600 hover:text-white font-normal text-lg'">
                            <router-link to="/">Home</router-link>
                        </li>
                        <li
                            :class="$route.name === 'about' ? 'text-white font-medium text-lg' : 'text-slate-600 hover:text-white font-normal text-lg'">
                            <router-link to="/about">About</router-link>
                        </li>
                        <li
                            :class="$route.name === 'projects' ? 'text-white font-medium text-lg' : 'text-slate-600 hover:text-white font-normal text-lg'">
                            <router-link to="/projects">Projects</router-link>
                        </li>
                        <li
                            :class="$route.name === 'contact' ? 'text-white font-medium text-lg' : 'text-slate-600 hover:text-white font-normal text-lg'">
